...
pygame.init()
dir_path = r"C:\Users\UmurY\OneDrive\Masaüstü\Multiarr_58vids\24videos"
...
with open(r'C:\Users\UmurY\OneDrive\Masaüstü\Multiarr_58vids\batches24.txt', 'r') as f:
...
for batch_indexes in batches:
    ...
    while running==True:
        ...
        pygame.display.flip()
#save dataframe as an excel file with regards to participant number asked in the beginning
df.to_excel(f'participant_{participant_number}.xlsx', index=True)
