...
function [] = extract_action_betas_BIDS_1session(roi)

cd(['/Users/burcuaysenurgen/Studies/SPM_ActionClustersBIDS_Subj04_Sess1/SPM/' roi]);
load('allBetas.mat')
...
cd('/Users/burcuaysenurgen/Studies/ACTION_CLUSTERS_RAW_DATA/subject04/Behavior/session1/');
