...
cd('/Users/burcuaysenurgen/Documents/Projects/ActionClusters/Data_fMRI/subjects/subject02/SPM12_Firstlevel_9sec/Clustering_PMC_volume_spm12/');
load('sorted_action_betas.mat');
[avg_ranked_value_mat_100splits] = split_ranking_procedure_bilkent(sorted_action_betas);
