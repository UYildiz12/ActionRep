...
function [avg_ranked_value_mat_100splits] = split_ranking_procedure_bilkent(data)
...
for k = 1:100 % repeat splitting 100 times
    ...
    randindices = randperm(24);
    
    indices_for_rank = randindices(1:12); % normally should be 1:6
    indices_for_value = randindices(13:24); % normally should be 7:12
