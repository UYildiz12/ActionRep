...
function [] = extract_action_betas_BIDS_2session(roi)

cd(['/Users/burgen/Studies/Action100_BILKENT/subjects/subject01/SPM_wregressors/' roi]);
load('allBetas.mat')

action_betas = [];
action_beta_indices = {};
act_indices = [1:56:896];
...
cd('/Users/burgen/Studies/Action100_BILKENT/subjects/subject01/SPM_wregressors/');
