...
cluster8 = X(idx16 == 8, :);
cluster9 = X(idx16 == 9, :);
cluster10 = X(idx16 == 10, :);
cluster11 = X(idx16 == 11, :);
cluster12 = X(idx16 == 12, :);
cluster13 = X(idx16 == 13, :);
cluster14 = X(idx16 == 14, :);
cluster15 = X(idx16 == 15, :);
cluster16 = X(idx16 == 16, :);
