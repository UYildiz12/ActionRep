...
mainDir = '/Volumes/BAURGEN/ActionClusters_ParametricModulator/subject03/SPM/INPUT_FITTED_ONLYPOSITIVE_AUC/Clustering_PPC_volume_FINAL/ClusteringWithProb/run1_100/';
cd(mainDir)
...
mainDirLeo = '/Volumes/BAURGEN/ActionClusters_ParametricModulator/subject03/SPM/INPUT_FITTED_ONLYPOSITIVE_AUC/Clustering_PPC_volume_FINAL/LeopoldProp/';
cd(mainDirLeo)

probMatrix_k9 = probMatrix;
save probMatrix_k9 probMatrix_k9
